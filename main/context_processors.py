...
def extract_resources_from_query(query, stations_dict):
    ...
    stop_words = ['из', 'от', 'со', 'с', 'в', 'до', 'на', 'расписание', 'когда', 'во', 'сколько', 'график', 'поезд',
                  'электричка', 'свободн', 'есть', 'место', 'билет', 'забронировать', 'купить']
        ...
        if from_code and to_code:
            try:
                ...
                if isinstance(response, str):
                    print(f"Ответ API строка: {response[:500]}")
